...
#include <debug.h>
smallsquare::Shader * Debug::_debugShader;


void Debug::Init(smallsquare::Shader * shader) {
    Debug::_debugShader = shader;
}

void Debug::DrawRay(vec3 start, vec3 end, vec3 color) {
    DebugLine ray{};
    ray.vertices = {
    ...
    _debugShader->Use();
    _debugShader->SetVec3("color", color);
